...
if __name__ == "__main__":
    ...
    MODEL_CHKP_PATH = "/home/anirudh/NJ/Interview/Pheno-Inspect/git_proj/coding_task_make-a-model/src/lightning_logs/" \
                      "version_116/checkpoints/epoch=149-step=299.ckpt"
    ...
    with torch.no_grad():
        ...
        print(np.unique(output_seg))
        plt.imshow(np.squeeze(output_seg), cmap='Blues')
        plt.show()
